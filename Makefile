#############################################################################
# Makefile for building: build/simulador.app/Contents/MacOS/simulador
# Generated by qmake (3.1) (Qt 6.9.1)
# Project:  simulador.pro
# Template: app
# Command: /opt/homebrew/Cellar/qt/6.9.1/bin/qmake -o Makefile simulador.pro -spec macx-clang
#############################################################################
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /opt/homebrew/Cellar/qt/6.9.1/bin/qmake -install qinstall
QINSTALL_PROGRAM = /opt/homebrew/Cellar/qt/6.9.1/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
SOURCES       = src/simulador/main.cpp \
		...
		src/VideoFollower.cpp build/moc/moc_mainwindow.cpp \
		build/moc/moc_VideoFollower.cpp
OBJECTS       = build/obj/main.o \
		build/obj/mainwindow.o \
		build/obj/Broker.o \
		build/obj/Component.o \
		build/obj/Follower.o \
		build/obj/Publisher.o \
		build/obj/Recorder.o \
		build/obj/VideoPublisher.o \
		build/obj/VideoFollower.o \
		build/obj/moc_mainwindow.o \
		build/obj/moc_VideoFollower.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		simulador.pro src/simulador/mainwindow.h \
		includes/Broker.h \
		...
		includes/VideoPublisher.h src/simulador/main.cpp \
		src/simulador/mainwindow.cpp \
		src/Broker.cpp \
		src/Component.cpp \
		src/Follower.cpp \
...
DESTDIR       = build/
TARGET        = build/simulador.app/Contents/MacOS/simulador

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/bmatus/Documents/GitHub/matus.benjamin-saavedra.diego-garcia.abraham-monteverde.juan-Tarea3.2025.1/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/bmatus/Documents/GitHub/matus.benjamin-saavedra.diego-garcia.abraham-monteverde.juan-Tarea3.2025.1/simulador.pro
...
build/simulador.app/Contents/MacOS/simulador: build/ui/ui_mainwindow.h $(OBJECTS)  
	@test -d build/simulador.app/Contents/MacOS/ || mkdir -p build/simulador.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: simulador.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/macx.conf \
...
build/simulador.app/Contents/PkgInfo: 
	@test -d build/simulador.app/Contents || mkdir -p build/simulador.app/Contents
	@$(DEL_FILE) build/simulador.app/Contents/PkgInfo
	@echo "APPL????" > build/simulador.app/Contents/PkgInfo
build/simulador.app/Contents/Info.plist: 
	@test -d build/simulador.app/Contents || mkdir -p build/simulador.app/Contents
	@$(DEL_FILE) build/simulador.app/Contents/Info.plist
	@plutil -convert xml1 -o - Info.plist | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.simulador,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.simulador,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,simulador,g" -e "s,@LIBRARY@,simulador,g" -e "s,\$${EXECUTABLE_NAME},simulador,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >build/simulador.app/Contents/Info.plist

all: Makefile \
		build/simulador.app/Contents/PkgInfo \
		build/simulador.app/Contents/Info.plist build/simulador.app/Contents/MacOS/simulador
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/simulador/mainwindow.h includes/Broker.h includes/Component.h includes/Follower.h includes/Publisher.h includes/Recorder.h includes/Subscriber.h includes/VideoFollower.h includes/VideoPublisher.h $(DISTDIR)/
	$(COPY_FILE) --parents src/simulador/main.cpp src/simulador/mainwindow.cpp src/Broker.cpp src/Component.cpp src/Follower.cpp src/Publisher.cpp src/Recorder.cpp src/VideoPublisher.cpp src/VideoFollower.cpp $(DISTDIR)/
	$(COPY_FILE) --parents src/simulador/mainwindow.ui $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r build/simulador.app
...
build/moc/moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang++ -pipe -stdlib=libc++ -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk -mmacosx-version-min=14.0 -Wall -Wextra -dM -E -o build/moc/moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: build/moc/moc_mainwindow.cpp build/moc/moc_VideoFollower.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc/moc_mainwindow.cpp build/moc/moc_VideoFollower.cpp
...
build/ui/ui_mainwindow.h: src/simulador/mainwindow.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic src/simulador/mainwindow.ui -o build/ui/ui_mainwindow.h
...
build/obj/mainwindow.o: src/simulador/mainwindow.cpp src/simulador/mainwindow.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/mainwindow.o src/simulador/mainwindow.cpp

build/obj/Broker.o: src/Broker.cpp includes/Broker.h \
		includes/Subscriber.h \
		includes/Component.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/Broker.o src/Broker.cpp

build/obj/Component.o: src/Component.cpp includes/Component.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/Component.o src/Component.cpp

build/obj/Follower.o: src/Follower.cpp includes/Follower.h \
		includes/Subscriber.h \
		includes/Component.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/Follower.o src/Follower.cpp

build/obj/Publisher.o: src/Publisher.cpp includes/Publisher.h \
		includes/Broker.h \
		includes/Subscriber.h \
		includes/Component.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/Publisher.o src/Publisher.cpp

build/obj/Recorder.o: src/Recorder.cpp includes/Recorder.h \
		includes/Subscriber.h \
		includes/Component.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/Recorder.o src/Recorder.cpp

build/obj/VideoPublisher.o: src/VideoPublisher.cpp includes/VideoPublisher.h \
		includes/Publisher.h \
		includes/Broker.h \
		includes/Subscriber.h \
		includes/Component.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/VideoPublisher.o src/VideoPublisher.cpp

build/obj/VideoFollower.o: src/VideoFollower.cpp includes/VideoFollower.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QObject \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		includes/Subscriber.h \
		includes/Component.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/VideoFollower.o src/VideoFollower.cpp
...
build/obj/moc_VideoFollower.o: build/moc/moc_VideoFollower.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/obj/moc_VideoFollower.o build/moc/moc_VideoFollower.cpp
